...
BasicEnemy::BasicEnemy(float x, float y, float w, float h, float zRot)
...
BasicEnemy::BasicEnemy(const glm::vec2& pos, const glm::vec2& size, float zRot)
...
void BasicEnemy::Update(Window& window, float boundsLeft, float boundsRight, float boundsTop, float boundsBottom, const std::map<std::string, Mix_Chunk*>& soundEffects)
{
...
void BasicEnemy::Render(Shader& shader, unsigned int renderMode)
{
